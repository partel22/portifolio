...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" ">
  ...
  <body oncontextmenu="return false" class="snippet-body">
    <div class="container d-flex justify-content-center">
      <div class="card mt-5 px-3 py-4">PARTELTECH
        ...
        <div class="media mt-4 pl-2">
          ...
          <div class="media-body">
            <h6 class="mt-1" style="color: gold; background: black; border-radius: 5px;" >Service Fee.</h6>
          </div>
        </div>
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" name="amount" placeholder="Enter Amount" step="50" min="200">
                </div>
                <div class="col-12">
