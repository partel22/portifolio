               ...
               <div class="profile-header">
                  ...
                  <div class="profile-header-content">
                     ...
                     <div class="profile-header-info">
                        <h4 class="m-t-10 m-b-5">John Partel</h4>
                        <p class="m-b-10">Freelancer + Fullstack Developer</p>
                     ...
                     <ul class="timeline">
                        <li>
                           ...
                           <div class="timeline-body">
                              <div class="timeline-header">
                                 ...
                                 <span class="username"><a href="javascript:;">Mercy Cersor</a> <small></small></span>
                        ...
                        <li>
                           ...
                           <div class="timeline-body">
                              <div class="timeline-header">
                                 <span class="userimage"><img src="https://bootdey.com/img/Content/avatar/avatar3.png" alt=""></span>
                                 <span class="username">Divina Atad</span>
                                 <span class="pull-right text-muted">1,282 Views</span>
                              </div>
                              <div class="timeline-content">
                                 <p class="lead">
                                    <i class="fa fa-quote-left fa-fw pull-left"></i>
                                    What a wonderful site! I really learnt many skills. And I apprecite Parteltech.
